...
struct ds_buffer wasm_file_dump(struct arena *mem, const char *path, const struct file *dir)
{
...
struct ds_buffer wasm_file_dump_at_cwd(struct arena *mem, const char *path)
{
