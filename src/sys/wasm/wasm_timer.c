...
u64	(*time_ns_from_os_source)(const u64 ns_os_time);	/* returns os_time - timer.ns_start */
...
void 	(*time_set_kt_transform_parameters)(const u64 time_mult, const u64 time_zero, const u64 time_shift); u64 	(*freq_rdtsc)(void);
...
void time_init(void)
{
	...
	time_ns_from_os_source = NULL;
	time_set_kt_transform_parameters = NULL;
